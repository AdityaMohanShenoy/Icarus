...
def runner(w):
    pygame.init()
    pygame.mixer.init()
    gamemusic=pygame.mixer.music.load("sounds/patil game.mp3")
    ...
    pygame.mixer.Sound.set_volume(fireball_sound,0.2)
    sword_sound=pygame.mixer.Sound("sounds/swordhit.wav")
    pygame.mixer.Sound.set_volume(sword_sound,0.4)
    explode_sound=pygame.mixer.Sound("assets/explode.mp3")
    pygame.mixer.Sound.set_volume(explode_sound,0.5)
    class Player:
